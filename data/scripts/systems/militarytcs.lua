...
--[[
    ...
    local techs = { 
        ...
        { -- 索坦逆向
            ...
            perfor1 = "逆向科技",  perfor2 = "质量优先", perfor3 = "火力网络模块", perfor4 = ""
        }, 
----------------------------------------------------------------------------------------------------------------------------------------------
        { -- 彩蛋：晓立天下
        ...
        { -- 彩蛋：蔚蓝档案
            ...
            text1 = "", text2 ="", text3 ="",
            perfor1 = "寥若晨星",  perfor2 = "粗劣算法", perfor3 = "火力网络模块", perfor4 = ""
        },
        { -- 闪耀科技
...
----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        { -- 大秦军工
            ...
            perfor1 = "并行调度处理器",  perfor2 = "智能网络模块", perfor3 = "防御网络模块", perfor4 = ""
        },
        { -- 惠民企业
        ...
        { -- 彩蛋：焚风反抗军
            ...
            perfor1 = "寥若晨星",  perfor2 = "质量优先", perfor3 = "防御网络阵列", perfor4 = ""
        }, 
        { -- AI
    ...
    local baseTurrets = math.max(1, rarity.value + tech.rarity + 1) -- 原神
    local permTurrets = baseTurrets + math.max(1, (rarity.value + tech.rarity + 1) / 2)

    local turrets = baseTurrets  -- 甘雨
    

    local pdcs = baseTurrets / 2  -- 迪卢克

    -- 科技等级-1 ~ 最大炮台栏位-1
    local autos = math.max(0, getInt(math.max(0, rarity.value + tech.rarity - 1), permTurrets - 1)) -- 胡桃

    if permanent then
        turrets = (permTurrets + tech.turretBonuses) * tech.permTrue
        pdcs = (pdcs + tech.pdcBonuses) * tech.permTrue
        autos = (autos + tech.autoBonuses) * tech.permTrue
    else
        turrets = turrets * tech.turretBaseFactor * tech.permFalse
        pdcs = pdcs * tech.pdcBaseFactor * tech.permFalse
