...
function getTooltipLines(seed, rarity, permanent)
    return
    {
        {ltext = "This artifact seems to function as /* continues with 'some kind of ancient gate key.' */"%_t, rtext = "", icon = ""},
        {ltext = "some kind of ancient gate key. /* Continued from 'This artifact seems to function as'*/"%_t, rtext = "", icon = ""},
    }
end
